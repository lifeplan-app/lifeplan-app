 ...
 *
 * Phase 3 Step 2 時点: ASSET_TYPES / TAX_TYPE_DEFAULT / TAX_RATE /
 *   effectiveReturn / calcAssetGrowth / calcAllAssetGrowth は
 *   calc/asset-growth.js に移動済み。テスト側は loadCalc 経由で参照する。
 *   ここに残るのは projectEmergencyBalance / calcEndYearFromAge /
 *   calcEndAgeFromYear（Task 10 で test-helpers.js へ移動予定）。
 */
